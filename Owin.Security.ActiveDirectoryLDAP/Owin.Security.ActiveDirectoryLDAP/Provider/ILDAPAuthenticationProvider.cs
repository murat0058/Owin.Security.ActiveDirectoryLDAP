...
{
    /// <summary>
    /// Specifies callback methods which the <see cref="LDAPAuthenticationMiddleware"></see> invokes to enable developer control over the authentication process. />
    /// </summary>
    public interface ILDAPAuthenticationProvider
    {
        ...
        void ApplyRedirect(LDAPApplyRedirectContext context);
    }
}
