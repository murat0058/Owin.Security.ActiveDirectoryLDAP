...
namespace Owin.Security.ActiveDirectoryLDAP.Attributes
{
    [AttributeUsage(AttributeTargets.Method | AttributeTargets.Class, Inherited = true, AllowMultiple = true)]
    public class GroupAuthorizeAttribute : AuthorizationFilterAttribute, IAuthorizationFilter, IFilter
    {
        ...
        protected virtual bool IsAuthorized(HttpActionContext actionContext)
        {
            ...
            IPrincipal user = System.Web.HttpContext.Current.User;//This is bad form.
